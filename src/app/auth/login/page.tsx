      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        {sent ? (
          <div className="glass rounded-xl p-6 text-center space-y-2">
            <p className="text-green-400 font-medium">Lien envoyé !</p>
          ...
          <div className="glass rounded-xl p-6 space-y-4">
            <form onSubmit={handleMagicLink} className="space-y-3">
              <input
                ...
                required
                className="w-full px-4 py-2.5 rounded-lg bg-white/5 border border-white/10 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-brand-500"
              />
              <button
                type="submit"
                disabled={loading}
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs text-gray-500">
                <span className="px-2 bg-gray-950">ou</span>
              </div>
            </div>

            <button
              onClick={handleGoogle}
              className="w-full py-2.5 rounded-lg glass glass-hover text-gray-300 font-medium flex items-center justify-center gap-2"
            >
